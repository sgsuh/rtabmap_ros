...
# "stdbuf -o L ros2 launch rtabmap_launch rtabmap_amr.launch.py ..."
#
...
def launch_setup(context, *args, **kwargs):
    ...
    return [
        ...
        # Preprocesses/Relays laser scans
        Node(
        ...
        # visualization
        Node(
            package='rtabmap_viz', executable='rtabmap_viz', name="rtabmap_viz", output='log',
            parameters=[{
                "subscribe_depth": LaunchConfiguration('depth'),
                "subscribe_rgbd": LaunchConfiguration('subscribe_rgbd'),
                "subscribe_rgb": LaunchConfiguration('subscribe_rgb'),
            ...
            arguments=[LaunchConfiguration("gui_cfg"), "--ros-args", "--log-level", LaunchConfiguration('log_level')],
            prefix=LaunchConfiguration('launch_prefix'),
            namespace=LaunchConfiguration('full_namespace')),
        Node(
